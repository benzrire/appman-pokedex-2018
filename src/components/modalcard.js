...
class ModalCard extends Component {
  ...
  addClickHandler = (event) => {
    this.props.setPokedex([...this.props.pokedex.dex, this.props.info])
  }
        ...
        <div className="card-body d-flex flex-row p-2"
          ...
          <div className="d-flex flex-column pl-2 w-100">
            <div className="d-flex flex-row w-100 justify-content-between">
              ...
              {this.state.cardHover && <button className="close" type="button"
                onClick={(e) => this.addClickHandler(e)}
                style={{fontSize: '25px', color: UI_COLORS.bottomBarBackground}}>Add</button>}
            </div>
            <div className="d-flex flex-row w-100">
              <span style={{fontSize: '16px'}}>HP</span>
              <div className="progress ml-auto mr-5" style={{width: '400px',backgroundColor: UI_COLORS.levelTubeBackground, marginTop: '3px'}}>
